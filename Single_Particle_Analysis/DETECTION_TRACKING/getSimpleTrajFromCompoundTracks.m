...
% extract the subset of compound tracks, then breaks these compuind tracks
...
%% Set up some basics
    ...
    for i=1:numCTracks
        ...
        for j = 1:ncTrks      
            ...
            out(cnt+j).x = floor(naninterp(x));
            out(cnt+j).y = floor(naninterp(y));
            out(cnt+j).I = floor(naninterp(I));
