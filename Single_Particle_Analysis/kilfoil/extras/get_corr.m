...
function [bres CorrDist xs lxs id lid amatw bmatw]=get_corr(t,lbinparams,dt,dim,dedrift,CorrDist)
        ...
        if ngood > 1   %; we should check!
            ...
            if nok > 0
                ...
                if dim == 2
                    ...
                    if detail
                        tau = ones(1,length(r))*dt;
                        CorrDist = [CorrDist [tempids; r'; tau; ddl';ddt']];
                    else
                        CorrDist  = [];
                    end
